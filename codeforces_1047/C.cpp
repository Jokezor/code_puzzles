...
void solution() {
  ...
  // Testing all possible multiples not possible.
  //
  // First check if parity is equal, if not then return -1
  ...
  // Binary search it, if cand > prev, keep going in that direction.
  while (low <= high) {
