...
void solution() {
  ...
  // Solve it
  //
  // Visisble for m+1 minutes after launch.
  // If one firework was launched m minutes after another, both fireworks will be visible for one minute.
  //
  // Basically, count how many fireworks are launched until m/a or m/b.
  //
  ll a, b, m;
  cin >> a >> b >> m;

  // When the installations sync, both fire at same time.
  ll ans = 2;

  // How many more will be fired in m seconds
  ll concurrent = m/a + m/b;
