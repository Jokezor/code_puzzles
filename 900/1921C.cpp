...
void solution() {
  ...
  // Basically, if the time between messages 
  // (m[i+1] - m[i])*a > b
  // Then turn off the phone.
  //
  // So we should calculate a minimum sum of the charged needed.
  // If charge_needed > f then output no.
