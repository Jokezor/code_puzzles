...
void solution() {
  ...
  // Simplest way is to record states.
  // If seen before, then NO.
  //
  cin >> n;
  vector<ll> a(n);
  ...
  // Check if all odd or even?
  // Yes, since adding 2 does not change the parity of that element.
  // But the subtraction changes it for all others.
  // Which means after 2 turns, we have the same parity and can not change it.
