...
void solution() {
  ...
  // Check odd divisors.
  // Either run for loop from 3, ..., sqrt(n).
  // Yes, simple, sqrt(N) time and can early exit.

  // Or, if it is not a power of 2, then it should have an odd factor.
  // log(N)
  
  // Or like this:
  // n is power of 2, means one bit is set.
  // n-1 will thus have all lower bits set.
  // Thus if they both have any bit in common, then
