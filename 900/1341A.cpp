...
void solution() {
  ...
  // Basically, can there be n grains that sum to greater than c-d
  // And less than c+d.
  //


  ll lower_grains = n*(a-b);
  ll upper_grains = n*(a+b);

  ll lower_box = c-d;
  ll upper_box = c+d;

  // cout << "(" << lower_grains  << ", " << upper_grains << ")\n";
  // cout << "[" << lower_box  << ", " << upper_box << "]\n";
