...
void solution() {
  ...
  // Simple solution is to sort both, create it and check.
  // Or we can add in an iota.
  // Check if the index of any two numbers in A are +1, -1
  ...
  // So we need a lookup from value to index.
