...
typedef __gnu_pbds::tree<int, __gnu_pbds::null_type, greater_equal<int>,
...
void solution() {
  ...
  // 1. Take stars by cartesian coordinates.
  // 2. Count amount of stars in each level 0 to (N-1)
  ll ans = 1;
  ll max_jumps = 0;
