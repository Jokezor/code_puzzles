...
void solution() {
  ...
  // basically take 2/3 of value in 2nd value
  // then 1/3 values in singles
  //
  // n=7, x=3, y=4, 2 coins
  //
  // n=30, 10 doubles, 10 singles
  //
  //
  // n=31, 10 doubles, 11 singles
  // n=32, 11 doubles, 10 singles
  // n=33, 11 doubles, 11 singles
  //
