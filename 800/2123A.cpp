...
void solution() {
  ...
  // 2: Alice, 0, 1
  //
  // 0 + 1 != (3 % 4) = 3, gives Alice.
  //
  // 4: 0,1,2,3, bob.
  //
  // (0,3), (2,1)
  // Stupidly would just be to iterate through them.
  //
  // 5: 0,1,2,3,4
  //
  // (0, 3), (2, 1), (4, -)
  //
  // So, if odd, then Alice wins.
  //
  // 3: 0,1,2
  //
  // (0, 1), A
  ...
  // (6, 1), (5, 2), (0, 3), (4, -)
  //
  // How many summed pairs are equal to 3 mod 4?
  //
  // they need to be a combined distance of 3 from a multiple of 4.
  //
  // For 7, there is (0,1,2,3) (4,5,6)
  //
