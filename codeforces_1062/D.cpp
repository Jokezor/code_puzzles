...
void solution() {
  ...
  // 1. Generate all prime numbers O(N*sqrt(N))?
  // 2. Check the prime factorization of each number in a. N*sqrt(N)
  // 3. Check the smallest number not in the prime factorization that is present in all_primes.
  //
  // 4. Record the minimum over all numbers.
  vector<ll> factors = trial_division1(14948);
