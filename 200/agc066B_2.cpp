...
void solution() {
  ...
  // Basically go from beginning to end,
  // check if builds a palindrome or not.
  ...
  // Instead walk 2 steps at a time, compare if first half equal to second half.
  // Walk 2 steps since n needs to be even
