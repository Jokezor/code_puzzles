...
void solution() {
  ...
  // For each time t_i, we can either have waited more than t,
  // the water has stopped or refill the time upon which the water has been on
  ...
  // With this, we need to add t after the last person.
  ans += t;
  cout << ans << "\n";
