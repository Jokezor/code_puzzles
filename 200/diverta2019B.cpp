...
void solution() {
  ...
  // For example, we should first try as many r as possible.
  // Then we would try g and b.
  // We go until n on each.
  // So we would try first with smallest.
  // So make sure r is smallest, g next smallest, b largest.
