...
void solution() {
  ...
  // Essentially flipping all adjacent cards that touch a square.
  // All starts face up.
  // Which means that we can track the number of hits each square gets
  // Then we know that the ones with even count end up face up.

  // Oh, they will perform this for each square that contains a card.
  // Also we should count the number of those facedown.
}
