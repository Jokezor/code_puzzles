...
void solution() {
  ...
  // Seems we should just check for each point?
  // We will naturally go from 0 to n so we satisfy taking the smallest index anyway.
  ...
  // Now simply go through each student and checkpoint.
  for (int i=0; i < n; ++i) {
      int closest = -1;
